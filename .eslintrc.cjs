module.exports = {
  ...
  rules: {
    ...
    "vue/max-attributes-per-line": [
      "error", // This can be 'off', 'warn', or 'error'
      {
        singleline: {
          max: 1, // Max number of attributes in a single line
          allowFirstLine: true, // Whether to allow attributes on the first line of a multiline element
        },
        multiline: {
          max: 1, // Max number of attributes per line in multiline
        },
      },
    ],
  },
